...
function showLandingPage() {
  ...
  loginBtn.addEventListener('click', async (e) => {
    ...
    loginBtn.innerHTML = '<span class="inline-block animate-spin mr-2">â³</span> Loggar in...';
    ...
    try {
      ...
      loginErrorText.textContent = 'Inloggning misslyckades. FÃ¶rsÃ¶k igen.';
...
function showApp() {
  ...
  if (userDisplayEl && user) {
    userDisplayEl.textContent = user.name || user.username || 'AnvÃ¤ndare';
  }
