...
async function showDealsSection() {
  document.getElementById('content').innerHTML = `
    <div class="p-8">
      <h1 class="text-3xl font-bold text-gray-900 mb-4">SÃ¤ljtavla</h1>
      <p class="text-gray-600">Funktionen byggs just nu...</p>
    </div>
  `;
}
...
async function showCustomerCareSection() {
  document.getElementById('content').innerHTML = `
    <div class="p-8">
      <h1 class="text-3xl font-bold text-gray-900 mb-4">KundvÃ¥rd</h1>
      <p class="text-gray-600">Funktionen byggs just nu...</p>
    </div>
  `;
}
